            ...
            <li class="py-5">
              ...
              >
                ...
                <p class="mt-1 text-sm text-gray-600 line-clamp-2">
                  ...
                  Accusamus maxime ipsam reprehenderit rerum id repellendus
            ...
            <li class="py-5">
              ...
              >
                ...
                <p class="mt-1 text-sm text-gray-600 line-clamp-2">
                  ...
                  exercitationem. Voluptate quisquam iure assumenda consequatur
                  ex et recusandae. Alias consectetur voluptatibus. Accusamus a
                  ab dicta et. Consequatur quis dignissimos voluptatem nisi.
                </p>
              </div>
            </li>
          </ul>
